...
def load_data():
  ...
  f=h5py.File('/cstor/xsede/users/xs-jdakka/mina_standardized_lpf/shuffled_output_runs.hdf5','r')
  g=h5py.File('/cstor/xsede/users/xs-jdakka/mina_standardized_lpf/shuffled_output_labels.hdf5','r')
  h=h5py.File('/cstor/xsede/users/xs-jdakka/mina_standardized_lpf/shuffled_output_subjects.hdf5','r')
  i=h5py.File('/cstor/xsede/users/xs-jdakka/mina_standardized_lpf/shuffled_output_features.hdf5','r')
